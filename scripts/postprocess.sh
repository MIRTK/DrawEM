...
run mirtk padding $sdir/cortical-wm/$subj.nii.gz $f $sdir/cortical-wm/$subj.nii.gz 2000 0 -invert 
run mirtk padding $sdir/cortical-gm/$subj.nii.gz $f $sdir/cortical-gm/$subj.nii.gz 1000 0 -invert 
