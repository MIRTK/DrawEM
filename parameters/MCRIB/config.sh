...
export ATLAS_TISSUES="outlier csf gm wm"
export ATLAS_TISSUES_GROUPING="1 1 1 1"
...
export DEEP_CSF_PARTS="14 15"
export NONCORTICAL="$DEEP_GM $VENTRICLES $BRAINSTEM $CEREBELLUM $CORPUS_CALLOSUM $DEEP_CSF_PARTS"
...
export BOTH_HEMI_LABELS="75 76 90 170 192"

export CORTICAL_GM_LABEL=10000
export CORTICAL_WM_LABEL=20000
export EM_LABELS_TO_ALL_LABELS="1 1 4 1 2 9 1 3 11 1 4 12 1 5 13 1 6 14 1 7 15 1 8 17 1 9 18 1 10 26 1 11 28 1 12 43 1 13 48 1 14 50 1 15 51 1 16 52 1 17 53 1 18 54 1 19 58 1 20 60 1 21 75 1 22 76 1 23 90 1 24 91 1 25 93 1 26 170 1 27 192 1 28 4000 1 29 24 1 30 $CORTICAL_GM_LABEL 1 31 $CORTICAL_WM_LABEL"
